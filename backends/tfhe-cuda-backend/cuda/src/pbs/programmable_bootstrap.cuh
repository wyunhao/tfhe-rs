...
__device__ void
mul_ggsw_glwe(Torus *__restrict__ accumulator, double2 *__restrict__ fft,
              double2 *__restrict__ join_buffer,
              double2 *__restrict__ bootstrapping_key, int polynomial_size,
              uint32_t glwe_dimension, int level_count, int iteration, G &group,
