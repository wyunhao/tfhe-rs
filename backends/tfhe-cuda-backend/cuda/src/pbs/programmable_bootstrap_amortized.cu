...
void scratch_cuda_programmable_bootstrap_amortized_32(
  ...
  case 256:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<256>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 512:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<512>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 1024:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<1024>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 2048:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<2048>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 4096:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<4096>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 8192:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<8192>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 16384:
    scratch_programmable_bootstrap_amortized<uint32_t, int32_t, Degree<16384>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  default:
...
void scratch_cuda_programmable_bootstrap_amortized_64(
  ...
  switch (polynomial_size) {
  case 256:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<256>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 512:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<512>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 1024:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<1024>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 2048:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<2048>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 4096:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<4096>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 8192:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<8192>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  case 16384:
    scratch_programmable_bootstrap_amortized<uint64_t, int64_t, Degree<16384>>(
        stream, pbs_buffer, glwe_dimension, polynomial_size,
        input_lwe_ciphertext_count, max_shared_memory, allocate_gpu_memory);
    break;
  default:
...
void cuda_programmable_bootstrap_amortized_lwe_ciphertext_vector_32(
  ...
  switch (polynomial_size) {
  case 256:
    host_programmable_bootstrap_amortized<uint32_t, Degree<256>>(
    ...
    break;
  case 512:
    host_programmable_bootstrap_amortized<uint32_t, Degree<512>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 1024:
    host_programmable_bootstrap_amortized<uint32_t, Degree<1024>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 2048:
    host_programmable_bootstrap_amortized<uint32_t, Degree<2048>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 4096:
    host_programmable_bootstrap_amortized<uint32_t, Degree<4096>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 8192:
    host_programmable_bootstrap_amortized<uint32_t, Degree<8192>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 16384:
    host_programmable_bootstrap_amortized<uint32_t, Degree<16384>>(
        stream, (uint32_t *)lwe_array_out, (uint32_t *)lwe_output_indexes,
        (uint32_t *)lut_vector, (uint32_t *)lut_vector_indexes,
        (uint32_t *)lwe_array_in, (uint32_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
...
void cuda_programmable_bootstrap_amortized_lwe_ciphertext_vector_64(
  ...
  switch (polynomial_size) {
  case 256:
    host_programmable_bootstrap_amortized<uint64_t, Degree<256>>(
    ...
    break;
  case 512:
    host_programmable_bootstrap_amortized<uint64_t, Degree<512>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 1024:
    host_programmable_bootstrap_amortized<uint64_t, Degree<1024>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 2048:
    host_programmable_bootstrap_amortized<uint64_t, Degree<2048>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 4096:
    host_programmable_bootstrap_amortized<uint64_t, Degree<4096>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 8192:
    host_programmable_bootstrap_amortized<uint64_t, Degree<8192>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
    ...
    break;
  case 16384:
    host_programmable_bootstrap_amortized<uint64_t, Degree<16384>>(
        stream, (uint64_t *)lwe_array_out, (uint64_t *)lwe_output_indexes,
        (uint64_t *)lut_vector, (uint64_t *)lut_vector_indexes,
        (uint64_t *)lwe_array_in, (uint64_t *)lwe_input_indexes,
        (double2 *)bootstrapping_key, pbs_buffer, glwe_dimension, lwe_dimension,
