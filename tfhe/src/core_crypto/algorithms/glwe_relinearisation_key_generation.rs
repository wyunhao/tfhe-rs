...
///     DynamicDistribution::new_gaussian(StandardDev(0.00000000000000029403601535432533));
...
/// );
/// ```
pub fn generate_glwe_relinearisation_key<
    Scalar,
    NoiseDistribution,
    GlweKeyCont,
    RelinKeyCont,
...
pub fn allocate_and_generate_glwe_relinearisation_key<Scalar, NoiseDistribution, KeyCont, Gen>(
