...
///     DynamicDistribution::new_gaussian(StandardDev(0.000000000000000000029403601535432533));
...
/// let glwe_noise_distribution =
///     DynamicDistribution::new_gaussian(StandardDev(0.000000000000000315293223915005));
...
{
    let tensor_output =
        glwe_tensor_product(input_glwe_ciphertext_lhs, input_glwe_ciphertext_rhs, scale);
